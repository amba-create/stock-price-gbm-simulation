...
![](stock-prices-gbm_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->

``` r
{plot(log_returns, main = "Daily Log Returns", ylab = "Log Return")}
```

![](stock-prices-gbm_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](stock-prices-gbm_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](stock-prices-gbm_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](stock-prices-gbm_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
![](stock-prices-gbm_files/figure-gfm/unnamed-chunk-16-2.png)<!-- -->
...
![](stock-prices-gbm_files/figure-gfm/unnamed-chunk-16-3.png)<!-- -->
...
![](stock-prices-gbm_files/figure-gfm/unnamed-chunk-16-4.png)<!-- -->
...
![](stock-prices-gbm_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
...
![](stock-prices-gbm_files/figure-gfm/unnamed-chunk-23-1.png)<!-- -->
...
![](stock-prices-gbm_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
